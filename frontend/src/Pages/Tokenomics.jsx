...
export default function Tokenomics() {
  ...
  return (
    <div className="min-h-[100svh] w-full bg-white text-gray-900 flex flex-col">
      ...
      >
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Tokenomics</h1>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <a
            ...
            aria-label="Open tokenomics in a new tab"
          >
            Open
          </a>
          <a
            ...
            aria-label="Download Tokenomics PDF"
          >
            Download
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 flex-1">
        <div className="relative rounded-2xl border border-gray-200 ring-1 ring-black/5 shadow-sm overflow-hidden bg-white">
          ...
          <iframe
            title="tokenomics PDF"
            src="/tokenomics.pdf#view=FitH"
        ...
        <p className="mt-3 text-sm text-gray-600">
          ...
          <a className="underline" href="/tokenomics.pdf" target="_blank" rel="noopener noreferrer">
            open it in a new tab
          </a>{" "}
          or{" "}
          <a className="underline" href="/tokenomics.pdf" download>
            download it
          </a>.
        </p>
      </div>
