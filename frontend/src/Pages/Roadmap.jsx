...
export default function Roadmap() {
  ...
  return (
    <div className="min-h-[100svh] w-full bg-white text-gray-900 flex flex-col">
      ...
      >
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight">Roadmap</h1>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <a
            ...
            aria-label="Open roadmap in a new tab"
          >
            Open
          </a>
          <a
            ...
            aria-label="Download Roadmap PDF"
          >
            Download
          </a>
        </div>
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 flex-1">
        ...
        <p className="mt-3 text-sm text-gray-600">
          ...
          <a className="underline" href="/roadmap.pdf" target="_blank" rel="noopener noreferrer">
            open it in a new tab
          </a>{" "}
          or{" "}
          <a className="underline" href="/roadmap.pdf" download>
            download it
          </a>.
        </p>
      </div>
